...
?>
                    <li class="top_li"><span class="fa fa-phone"></span>
                        <a
                            href="tel:+255-<?php  echo $row['MobileNumber'];?>">+255-<?php  echo $row['MobileNumber'];?></a>
                    </li>
    ...
    <nav class="navbar navbar-expand-lg navbar-light py-lg-2 py-2">
        <div class="container">
            <a class="navbar-brand" href="index.php">
                <img src="./assets/images/pics/mylogo.png" alt="" height="65px" width="65px" class="logo">CAS
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="notice-details.php">Announcements</a>
                    </li>
                    <li class="nav-item">
