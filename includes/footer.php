        ...
        <div class="container">
            <div class="d-grid grid-col-4 footer-top-29">
              ...
              ?>
                        ...
                        <li><a href="tel:+255-<?php echo $row['MobileNumber']; ?>"><span class="fa fa-phone"></span>
                                +255-<?php echo $row['MobileNumber']; ?></a></li>
                        <li><a href="mailto:siddiquizaid213@gmail.com" class="mail"><span
                                    class="fa fa-envelope-open-o"></span> <?php echo $row['Email']; ?></a></li>
                        <?php } ?>
                    </ul>
            ...
            <div class="d-grid grid-col-2 bottom-copies">
                <p class="copy-footer-29">Designed & Developed by Alex Kehongo Mwera (Mr Arsenal)</p>
                <br>
