...
<head>
    ...
    <title>Home Page | College Admission Management System</title>
    <!-- web fonts -->
                            ...
                            <div class="banner-info">
                                <div class="container">
                                    <div class="banner-info-bg mx-auto text-center">
                                        ...
                                        <a class="btn btn-secondary btn-theme2 mt-md-5 mt-4" href="contact.php">Contact
                                            Now</a>
                                    </div>
                                ...
                                <div class="banner-info">
                                    <div class="container">
                                        <div class="banner-info-bg mx-auto text-center">
                                            ...
                                            <a class="btn btn-secondary btn-theme2 mt-md-5 mt-4" href="courses.php">View
                                                our
                                                Courses</a>
                                        </div>
                                    </div>
                                ...
                                <div class="banner-info">
                                    <div class="container">
                                        <div class="banner-info-bg mx-auto text-center">
                                            ...
                                            <a class="btn btn-secondary btn-theme2 mt-md-5 mt-4" href="about.html">Read
                                                More</a>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="calltoaction-20  py-5 editContent">
            ...
            ?>
                    ...
                    <div class="column ccont-left col-lg-6">
                        <img src="assets/images/pics/image3.jpg" class="img-responsive" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="grid grid-column-2 ">
                    ...
                    <div class="column1">
                        <div class="heading">
                            ...
                            <h4></h4>
                            <p class="my-3 text-white">Apply now to secure your spot and embark on an
                                exciting journey
                                towards academic excellence. Don't miss the opportunity to join our
                                prestigious
                                institution. Click the button below to begin your application process.</p>
                        </div>
                    </div>
                    <div class="column2">
                        <a class="btn btn-secondary btn-theme2 mt-3" href="user/login.php"> Click Here To
                            Apply</a>
                    </div>
                </div>
            </div>
            ...
            <div class="container py-md-3">
                <div class="pricing-style-w3ls row py-md-5">
                    <div class="pricing-chart col-lg-12">
                        <h3 class="">Latest Announcements</h3> <?php $query = mysqli_query($con, "select * from tblnotice ORDER BY ID DESC LIMIT 1");
                        ...
                        <div class="tatest-top mt-md-5 mt-4">
                            <div class="price-box btn-layout bt6">
                                <div class="grid grid-column-2">
                                    <div class="column-6">
                                        <img src="assets/images/pics/image4.jpg" alt="" class="img-fluid">
                                    </div>
                                    <div class="column1">
