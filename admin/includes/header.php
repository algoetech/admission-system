              ...
              <ul class="nav navbar-nav flex-row">
                  ...
                  <li class="nav-item mr-auto">
                      <a class="navbar-brand" href="dashboard.php">
                          ...
                          <h3 class="brand-text">CAS Admin</h3>
                      </a>
                  </li>
              ...
              <div class="collapse navbar-collapse" id="navbar-mobile">
                  ...
                  ?>
                          ...
                          <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item"
                                  href="adminprofile.php"><i class="ft-user"></i> Edit Profile</a>
                              <span class="avatar avatar-online">
                              </span>
                              </a>
                              <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item"
                                      href="change-password.php"><i class="ft-user"></i> Change Pass</a>
                      ...
                      <?php $qury = mysqli_query($con, "SELECT * FROM `tblcontact` WHERE `tblcontact`.`IsRead` = 0 or `tblcontact`.`IsRead` is null;");
                      ...
                      <li class="dropdown dropdown-notification nav-item">
                          ...
                          <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                              <li class="dropdown-menu-header">
                                  ...
                                  <span
                                      class="notification-tag badge badge-default badge-danger float-right m-0"><?php echo $num; ?>
                                      New</span>
                              </li>
                                  ...
                                  <a href="view-appform.php?aticid=<?php echo $row['appid']; ?>">
                                      <div class="media">
                                          ...
                                          <div class="media-body">
                                              <h6 class="media-heading"><b><?php echo $row['Name']; ?></b> Sends
                                                  an enquire
                                              </h6>
                                              <small>
                                                  <time class="media-meta text-muted"
                                                      datetime="2015-06-11T18:29:20+08:00">at
                                                      <?php echo $row['EnquiryDate']; ?></time>
                                              </small>
                                          </div>
                                      </div>
                                  </a>
