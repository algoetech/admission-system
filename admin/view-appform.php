...
?>
                    ...
                    <table border="1" width="100%" class="table table-bordered mg-b-0">
                        ...
                        <tr>
                            <th>Student Pic</th>
                            <td><img src="../user/userimages/<?php echo $row['UserPic'];?>" width="200" height="150">
                            </td>
                            <th>Father Name</th>
                        ...
                        <tr>
                            ...
                            <th>CSEE</th>
                            <td><a href="../user/userdocs/<?php echo $row['TransferCertificate'];?>"
                                    target="_blank">View File </a></td>
                        </tr>
                        <tr>
                            <th>ACSEE</th>
                            <td><a href="../user/userdocs/<?php echo $row['TenMarksheeet'];?>" target="_blank">View File
                                </a></td>

                            <th>CERTIFICATE</th>
                            <td><a href="../user/userdocs/<?php echo $row['TwelveMarksheet'];?>" target="_blank">View
                                    File </a></td>
                        </tr>
                        <tr>
                            <th>DIPLOMA</th>
                            <td>
                                ...
                                NA
                                <?php } else{ ?>
                                <a href="../user/userdocs/<?php echo $row['GraduationCertificate'];?>"
                            ...
                            <td>
                                ...
                                NA
                                <?php } else{ ?>
                                <a href="../user/userdocs/<?php echo $row['PostgraduationCertificate'];?>"
                                    target="_blank">View File </a>
                                <?php } ?>
                            </td>
                        </tr>
                    ...
                    <table class="table mb-0" border="1" width="100%">
                        ...
                        <tr>
                            <th colspan="5">
                                <font color="red">Declaration : </font>I hereby state that the facts mentioned above
                                are
                    ...
                    <table class="table mb-0" border="1" width="100%">
                        ...
                        <form name="submit" method="post" enctype="multipart/form-data">
                            ...
                            <tr>
                                <th>Admin Remark :</th>
                                <td>
                                    <textarea name="AdminRemark" placeholder="" rows="6" cols="14"
                            ...
                            <tr id="fee">
                                <th>Fee Amount :</th>
                                <td>
                                    <input name="feeamt" id="feeamt" placeholder="" class="form-control wd-450">
                                </td>
                            </tr>
