...
?>
                                                        <div class="form-group">
                                                            <input class="form-control white_bg" id="payamt"
                                                                name="payamt" type="text" readonly
                                                                value="<?php  echo $row['FeeAmount'];?>">
                                                ...
                                                <div class="col-xl-6 col-lg-12">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control white_bg" name="mop"
                                                                required="true">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6 col-lg-12">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input class="form-control white_bg" id="transno"
                                                                name="transno" type="text" required="true">
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                <div class="col-xl-6 col-lg-12">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input class="form-control white_bg" id="dot" name="dot"
