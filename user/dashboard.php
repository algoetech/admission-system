                                    ...
                                    <div class="card-body">
                                        <div class="media d-flex">
                                            <div class="media-body text-left">
                                                ...
                                                <?php } else {?>
                                                <h4 align="center">Your Application has been pending with admin for
                                                    review</h4>
                                                <?php } ?>
                            ...
                            <div class="card-content">
                                <a href="addmission-form.php">
                                    <div class="card-body">
                                        <div class="media d-flex">
                                            <div class="media-body text-left">
                                                <h4 align="center">You have not applied for addmision. Please fill the
                                                    admission form.</h4>
                                            </div>
                                            <div>
                                                <i class="icon-file success font-large-2 float-right"></i>
                                    ...
                                    <div class="card-body">
                                        <div class="media d-flex">
                                            <div class="media-body text-left">
                                                ...
                                                <h4 align="center">Your Application has been selected.Fee is also
                                                    submitted</h4>
                                    ...
                                    <div class="card-body">
                                        <div class="media d-flex">
                                            <div class="media-body text-left">
                                                ...
                                                <h4 align="center">Your Application has been selected and Please Submit
                                                    your fee.</h4>
